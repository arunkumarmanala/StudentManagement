	...
	<div class="container">
		...
		<div id="studentForm" style="display: none;">
			...
			<div class="form-group">
				<label>Firstname:</label> <span class="editable" id="firstname"></span>
				<i class="fas fa-pencil-alt" onclick="makeEditable('firstname')"></i>
			</div>
			<div class="form-group">
				<label>Lastname:</label> <span class="editable" id="lastname"></span>
				<i class="fas fa-pencil-alt" onclick="makeEditable('lastname')"></i>
			</div>
			<div class="form-group">
				<label>Phone:</label> <span class="editable" id="phone"></span> <i
					class="fas fa-pencil-alt" onclick="makeEditable('phone')"></i>
			</div>
			<div class="form-group">
				<label>Email:</label> <span class="editable" id="email"></span> <i
					class="fas fa-pencil-alt" onclick="makeEditable('email')"></i>
			</div>
		</div>
	</div>
